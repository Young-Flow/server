...
public class CompanyService {
    ...
    public LoginRes loginCompany(CompanyLoginReq req) {
        ...
        String accessToken = redisTokenUtil.issueAccessToken(company.getId(), MemberRole.COMPANY);
        String refreshToken = redisTokenUtil.issueRefreshToken(company.getId(), MemberRole.COMPANY);
